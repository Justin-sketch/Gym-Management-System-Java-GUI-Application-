...
public class MemberStats extends javax.swing.JFrame {
    ...
    public MemberStats() {
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("select exercise, personal_record, goal from exercises where member_id = ?");
            ps.setString(1, memberUsername);
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
                model.addRow(new Object[]{rs.getString("exercise"),rs.getString("personal_record"),rs.getString("goal")});
            }                                  
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Progress Stats");
