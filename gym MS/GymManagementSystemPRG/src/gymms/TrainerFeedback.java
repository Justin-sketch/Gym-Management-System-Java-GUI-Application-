...
public class TrainerFeedback extends javax.swing.JFrame {
    ...
    public TrainerFeedback() {
        ...
        String trainerUsername = SignIn.loggedInUsername;
        try{
            Connection con = DBConnection.getCon();
            PreparedStatement ps = con.prepareStatement("select member_id, feedback_or_report from feedback where trainer_id = ?");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Trainer Recieved Feedback");
