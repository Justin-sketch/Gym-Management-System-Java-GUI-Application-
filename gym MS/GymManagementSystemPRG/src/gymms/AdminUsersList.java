 ...
 * @author france
 */
public class AdminUsersList extends javax.swing.JFrame {
    ...
    public AdminUsersList() {
        ...
        try{
            ...
            while(rs.next()){
                model.addRow(new Object[]{"Member",rs.getString(1),rs.getString(2),rs.getString(3)});
            }                                  
        }catch(Exception e){
        ...
        try{
            ...
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
                model.addRow(new Object[]{"Trainer",rs.getString(1),rs.getString(2),rs.getString(3),});
            }                              
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
        ...
        try{
            ...
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
                model.addRow(new Object[]{"IT",rs.getString(1),rs.getString(2),rs.getString(3),});
            }                              
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }               
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUsersList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
